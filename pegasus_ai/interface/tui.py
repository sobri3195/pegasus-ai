...
from pegasus_ai.agents.PegasusAgent import PegasusAgent
from pegasus_ai.llm.config import LLMConfig
from pegasus_ai.telemetry.tracer import Tracer, set_global_tracer
...
class StrixTUIApp(App):  # type: ignore[misc]
    ...
    def _start_scan_thread(self) -> None:
        def scan_target() -> None:
            try:
                ...
                try:
                    agent = PegasusAgent(self.agent_config)
    ...
    def _render_chat_content(self, msg_data: dict[str, Any]) -> str:
        ...
        if role == "user":
            from pegasus_ai.interface.tool_components.user_message_renderer import UserMessageRenderer
    ...
    def _render_tool_content_simple(self, tool_data: dict[str, Any]) -> str:
        ...
        from pegasus_ai.interface.tool_components.registry import get_tool_renderer
    ...
    def _send_user_message(self, message: str) -> None:
        ...
        try:
            from pegasus_ai.tools.agents_graph.agents_graph_actions import send_user_message_to_agent
    ...
    def action_confirm_stop_agent(self, agent_id: str) -> None:
        ...
        try:
            from pegasus_ai.tools.agents_graph.agents_graph_actions import stop_agent
