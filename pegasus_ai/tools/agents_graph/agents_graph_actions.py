...
def create_agent(
    ...
    try:
        ...
        if module_list:
            from pegasus_ai.prompts import get_all_module_names, validate_module_names
        ...
        from pegasus_ai.agents import PegasusAgent
        from pegasus_ai.agents.state import AgentState
        ...
        agent = PegasusAgent(agent_config)
