...
lint:
    ...
    poetry run pylint pegasus_ai/ --score=no --reports=no
    @echo "✅ Linting complete!"

type-check:
    @echo "🔍 Type checking with mypy..."
    poetry run mypy pegasus_ai/
    @echo "🔍 Type checking with pyright..."
    poetry run pyright pegasus_ai/
    @echo "✅ Type checking complete!"

security:
    @echo "🔒 Running security checks with bandit..."
    poetry run bandit -r pegasus_ai/ -c pyproject.toml
...
test-cov:
    ...
    poetry run pytest -v --cov=pegasus_ai --cov-report=term-missing --cov-report=html
